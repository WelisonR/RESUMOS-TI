% OUTRO BOM MODELO:
% https://www.overleaf.com/project/5c1137550f061f3aa1368d42
...
% \setlength{\textfloatsep}{0.0cm} % Remove o espaço entre a imagem do topo e o texto

\begin{document} % declaração de que o documento começa aqui.

% \begin{figure}
%     \centering
%     \includegraphics[width=1.0\linewidth, height=1.0cm]{images/as_comp_PB.jpg}
%     \label{unb:unb_logo}
% \end{figure}
...
% \centerline{\textbf{\huge{Análise Combinatória}}}
\begin{center}
